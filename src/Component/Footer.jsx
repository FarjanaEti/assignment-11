...
import lotiieLogin from '../assets/Animation - 1735051633139.json'
...
<ul className="space-y-1">
			<li>
					...
					<li>
						<a rel="noopener noreferrer" href="#">What we do?</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
				<h3 className="uppercase dark:text-gray-900">Supporters</h3>
				<ul className="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#">Volunteer</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Rise founds</a>
					</li>
					<li>
			...
			<div className="space-y-3">
				...
				<div className="flex justify-start space-x-3">
					...
					<a rel="noopener noreferrer" href="https://x.com/i/flow/login" title="Twitter" className="flex items-center p-1">
